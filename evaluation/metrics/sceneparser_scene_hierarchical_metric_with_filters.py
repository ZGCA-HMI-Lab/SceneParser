...
def main():
    parser = argparse.ArgumentParser(
        description="Run scene-level sceneparser metric with optional filtering for fair comparison."
    )
    ...
    parser.add_argument(
        "--base_metric_script",
        type=str,
        default=str(Path(__file__).resolve().with_name("sceneparser_scene_hierarchical_metric.py")),
    )
    ...
    filtered = [filter_sample(s, args.ignore_pseudo_part, args.ignore_none_action) for s in samples]
