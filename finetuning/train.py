...
# Use SceneParser root as project root so this copied finetuning package is
# self-contained and does not accidentally import the original SceneParser/finetuning.
...
def train(attn_implementation="flash_attention_2"):
    ...
    print(f"modelname is {model_args.model_name_or_path}!!!!!")
