...
model_name_or_path = os.environ.get(
    "MODEL_NAME_OR_PATH",
    str(SCENEPARSER_ROOT / "finetuning" / "work_dirs" / "sceneparser_curriculum_stage2_mixed70pseudo30_when_available_4ep_from_stage1_3ep"),
)
...
sceneparser_structured_data = dict(
    ...
    dataset_name="sceneparser_curriculum_stage3_mixed50pseudo50_when_available_data",
)
